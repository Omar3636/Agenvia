...
<body>
    ...
    <?php else: ?>
        <?php foreach ($resultados as $viaje): ?>
            <div class="resultado">
                <h3>Lugar: <?php echo $viaje['hotel']; ?></h3>
                <p>
                    <?php echo $viaje['ciudad']; ?>, <?php echo $viaje['pais']; ?><br>
                    Fecha: <?php echo date('d/m/Y', strtotime($viaje['fecha'])); ?><br>
                    Duración: <?php echo $viaje['duracion']; ?> días<br>
                    <span class="precio">Precio $<?php echo $viaje['precio']; ?></span>
                </p>
            </div>
        <?php endforeach; ?>
    <?php endif; ?>
